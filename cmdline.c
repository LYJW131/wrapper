/*
  ...
  gengetopt --input=wrapper.ggo --output-dir=. --file-name=cmdline 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->base_dir_help = gengetopt_args_info_help[7] ;
  args_info->device_info_help = gengetopt_args_info_help[8] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVH:D:M:A:P:B:I:", long_options, &option_index);
